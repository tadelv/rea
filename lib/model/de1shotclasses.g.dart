...
Map<String, dynamic> _$De1ShotHeaderClassToJson(De1ShotHeaderClass instance) =>
    <String, dynamic>{
      ...
      'title': De1ShotHeaderClass._jsonString(instance.title),
      'author': De1ShotHeaderClass._jsonString(instance.author),
      'notes': De1ShotHeaderClass._jsonString(instance.notes),
